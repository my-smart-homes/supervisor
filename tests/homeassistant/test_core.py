...
async def test_start(
    ...
    with (
        ...
        assert (
            run.call_args.args[0] == "ghcr.io/my-smart-homes/qemux86-64-my-smart-homes"
        )
...
async def test_core_loads_wrong_image_for_machine(
    ...
    coresys.homeassistant.set_image("ghcr.io/my-smart-homes/odroid-n2-my-smart-homes")
    ...
    assert coresys.docker.images.delete.call_args_list[0] == call(
        "ghcr.io/my-smart-homes/odroid-n2-my-smart-homes:latest",
        force=True,
    )
    assert coresys.docker.images.delete.call_args_list[1] == call(
        "ghcr.io/my-smart-homes/odroid-n2-my-smart-homes:2024.4.0",
        force=True,
    )
    assert (
...
async def test_core_load_allows_image_override(coresys: CoreSys, container: MagicMock):
    ...
    assert (
        coresys.homeassistant.image == "ghcr.io/my-smart-homes/odroid-n2-my-smart-homes"
    )
...
async def test_core_loads_wrong_image_for_architecture(
    ...
    container.remove.assert_called_once_with(force=True, v=True)
    assert coresys.docker.images.delete.call_args_list[0] == call(
        "ghcr.io/my-smart-homes/qemux86-64-my-smart-homes:latest",
        force=True,
    )
    assert coresys.docker.images.delete.call_args_list[1] == call(
        "ghcr.io/my-smart-homes/qemux86-64-my-smart-homes:2024.4.0",
        force=True,
    )
    assert (
        coresys.homeassistant.image == "ghcr.io/my-smart-homes/qemux86-64-my-smart-homes"
